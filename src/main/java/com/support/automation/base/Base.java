package com.support.automation.base;
...
import com.support.automation.config.PropertyFileReader;
...
public class Base {
	...
	public static void navigateToApplicationUrl() throws InterruptedException{
		String url="";
		switch(Base.reader.getApplicationNumber()){
		case "1":
			url=Base.reader.geApplicationUrl1();
			break;
		case "2":
			url=Base.reader.geApplicationUrl2();
			break;
		case "3":
			url=Base.reader.geApplicationUrl3();
			break;
		case "4":
			url=Base.reader.geApplicationUrl4();
			break;
		case "5":
			url=Base.reader.geApplicationUrl5();
			break;
		case "6":
			url=Base.reader.geApplicationUrl6();
			break;
		}
 Base.driver.get(url);
 Thread.sleep(14564);
